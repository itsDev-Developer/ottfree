...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SurfTG — Stream your Telegram library" },
      { name: "description", content: "A premium streaming experience for your Telegram channels and folders. Watch anywhere, resume anywhere." },
      { name: "author", content: "SurfTG" },
      { property: "og:title", content: "SurfTG — Stream your Telegram library" },
      { property: "og:description", content: "Cinematic streaming UI for Telegram media." },
